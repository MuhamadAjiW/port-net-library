...
CONFIG_CLEAN_FILES = example/Makefile example/Makefile.dpdk \
	...
	tests/dga/Makefile influxdb/Makefile libndpi.pc \
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/libndpi.pc.in \
	...
	$(top_srcdir)/tests/unit/Makefile.in compile config.guess \
...
ACLOCAL = ${SHELL} /root/port-net-library/missing aclocal-1.16
ADDITIONAL_INCS = 
ADDITIONAL_LIBS = -lm
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /root/port-net-library/missing autoconf
AUTOHEADER = ${SHELL} /root/port-net-library/missing autoheader
AUTOMAKE = ${SHELL} /root/port-net-library/missing automake-1.16
AWK = mawk
BUILD_FUZZTARGETS = 0
BUILD_MINGW = 
BUILD_MINGW_X64 = 
...
EXEEXT = 
EXE_SUFFIX = 
EXTRA_TARGETS = example tests tests/dga tests/unit
FGREP = /usr/bin/grep -F
GIT_RELEASE = 4.10.0-2-54d2e0e
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /root/port-net-library/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /usr/bin/mkdir -p
NBPF_ENABLED = 0
NDPI_API_VERSION = 15
NDPI_BASE_DIR = 
NDPI_CFLAGS = -W -Wall -Wno-address-of-packed-member  -D_DEFAULT_SOURCE=1 -D_GNU_SOURCE=1 -O2 -DUSE_GLOBAL_CONTEXT
NDPI_LDFLAGS = 
NDPI_MAJOR = 4
NDPI_MINOR = 10
NDPI_PATCH = 0
NDPI_VERSION_SHORT = 4.10.0
NM = /usr/bin/nm -B
NMEDIT = 
OBJDUMP = objdump
OBJEXT = o
...
VERSION = 4.10.0
abs_builddir = /root/port-net-library
abs_srcdir = /root/port-net-library
abs_top_builddir = /root/port-net-library
abs_top_srcdir = /root/port-net-library
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/port-net-library/install-sh
...
SUBDIRS = src/lib example tests tests/dga tests/unit
